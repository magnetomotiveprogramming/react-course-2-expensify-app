...
//(startDate = undefined) noneed to set default value here, since we already set a default value down below at filtersReducerDefaultState
...
// console.log('anicestring'.includes('nice'))